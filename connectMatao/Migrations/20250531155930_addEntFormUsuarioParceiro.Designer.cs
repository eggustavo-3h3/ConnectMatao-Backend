...
namespace connectMatao.Migrations
{
    ...
    [Migration("20250531155930_addEntFormUsuarioParceiro")]
    partial class addEntFormUsuarioParceiro
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("connectMatao.Domain.Entities.FormUsuarioParceiro", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("FormsUsuarioParceiro");
                });
            ...
            modelBuilder.Entity("connectMatao.Domain.Entities.FormUsuarioParceiro", b =>
                {
                    b.HasOne("connectMatao.Domain.Entities.Usuario", "Usuario")
                        .WithOne("FormUsuarioParceiro")
                        .HasForeignKey("connectMatao.Domain.Entities.FormUsuarioParceiro", "UsuarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("connectMatao.Domain.Entities.Usuario", b =>
                {
                    b.Navigation("FormUsuarioParceiro");
                });
